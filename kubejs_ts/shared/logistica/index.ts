...
export function registerBlocks(event: Block) {
  ...
  event
    ...
    .texture(
      ["up"],
      "kubejs:block/mining_outpost_controller/mining_outpost_controller_top",
    )
    .texture(
      ["north", "east", "south", "west"],
    ...
    .texture(
      ["down"],
      "kubejs:block/mining_outpost_controller/mining_outpost_controller_bottom",
    )
  ...
  event
    ...
    .texture(
      ["up"],
      "kubejs:block/village_market_controller/village_market_controller_top",
    )
    .texture(
      ["north", "east", "south", "west"],
    ...
    .texture(
      ["down"],
      "kubejs:block/village_market_controller/village_market_controller_bottom",
    )
  ...
  event
    ...
    .texture(
      ["up"],
      "kubejs:block/hub_dispatch_controller/hub_dispatch_controller_top",
    )
    .texture(
      ["north", "east", "south", "west"],
    ...
    .texture(
      ["down"],
      "kubejs:block/hub_dispatch_controller/hub_dispatch_controller_bottom",
    )
